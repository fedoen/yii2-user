...
class AdminController extends Controller
{
     ...
     * Triggered with \fedoen\user\events\UserEvent.
     */
    ...
    /**
     * If "fedoen/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(\Yii::$app->extensions['fedoen/yii2-rbac'])) {
