...
```php
class User extends \fedoen\user\models\User
{
...
You should override view file `@fedoen/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \fedoen\user\models\RegistrationForm
{
    /**
     * @var string
     */
