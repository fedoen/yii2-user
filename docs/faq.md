...
'modules' => [
    'user' => [
        ...
        'controllerMap' => [
            'admin' => [
                'class'  => 'fedoen\user\controllers\AdminController',
                'layout' => '//admin-layout',
            ],
        ],
    ],
...
'modules' => [
    'user' => [
        ...
        'controllerMap' => [
            'recovery' => [
                'class' => \fedoen\user\controllers\RecoveryController::class,
                'on ' . \fedoen\user\controllers\RecoveryController::EVENT_AFTER_REQUEST => function (\fedoen\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
                'on ' . \fedoen\user\controllers\RecoveryController::EVENT_AFTER_RESET => function (\fedoen\user\events\ResetPasswordEvent $event) {
            ...
            'registration' => [
                'class' => \fedoen\user\controllers\RegistrationController::class,
                'on ' . \fedoen\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function (\fedoen\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
                'on ' . \fedoen\user\controllers\RegistrationController::EVENT_AFTER_RESEND => function (\fedoen\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
            ],
